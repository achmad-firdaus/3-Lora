...
class Dashboard extends CI_Controller {
    ...
    public function getData ()
    {
        ...
        // earthquake Node 1
        $node1_earthquake1 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n1)->where('value > 0')->where('LOWER(date) = "mon" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node1_earthquake2 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n1)->where('value > 0')->where('LOWER(date) = "tue" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node1_earthquake3 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n1)->where('value > 0')->where('LOWER(date) = "wed" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node1_earthquake4 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n1)->where('value > 0')->where('LOWER(date) = "thu" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node1_earthquake5 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n1)->where('value > 0')->where('LOWER(date) = "fri" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node1_earthquake6 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n1)->where('value > 0')->where('LOWER(date) = "sat" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node1_earthquake7 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n1)->where('value > 0')->where('LOWER(date) = "sun" ')->order_by('created_dt', 'DESC')->get()->row_array();
        // earthquake Node 2
        $node2_earthquake1 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n2)->where('value > 0')->where('LOWER(date) = "mon" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node2_earthquake2 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n2)->where('value > 0')->where('LOWER(date) = "tue" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node2_earthquake3 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n2)->where('value > 0')->where('LOWER(date) = "wed" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node2_earthquake4 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n2)->where('value > 0')->where('LOWER(date) = "thu" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node2_earthquake5 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n2)->where('value > 0')->where('LOWER(date) = "fri" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node2_earthquake6 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n2)->where('value > 0')->where('LOWER(date) = "sat" ')->order_by('created_dt', 'DESC')->get()->row_array();
        $node2_earthquake7 = $this->db->select('COALESCE(FORMAT(FLOOR(COUNT(value)),0), 0) AS valueh, time, date, created_dt')->from($this->table_earthquake_n2)->where('value > 0')->where('LOWER(date) = "sun" ')->order_by('created_dt', 'DESC')->get()->row_array();
